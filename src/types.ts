...
export interface MoltbotEnv {
  ...
  OPENAI_BASE_URL?: string; // OpenAI-compatible provider URL (e.g., https://api.fireworks.ai/inference/v1)
  AI_PROVIDER?: string; // 'anthropic' or 'openai' - explicitly select provider
  MODEL?: string; // Custom model ID (e.g., accounts/fireworks/models/kimi-k2p5)
